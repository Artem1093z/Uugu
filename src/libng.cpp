...
// ======================== ОФФСЕТЫ ========================
#define RVA_UPDATE oxorany((uintptr_t)0x93E4D8C) 
#define RVA_RAYCAST oxorany((uintptr_t)0xA1453D0)  
#define RVA_ON_SCREEN_MOUSE_TYPEINFO oxorany((uintptr_t)0xAC51C10) // <-- Прямой оффсет TypeInfo!

#define RVA_GET_CAM_COUNT oxorany((uintptr_t)0xA00D604)
#define RVA_GET_MAIN_CAM oxorany((uintptr_t)0xA00C3D4)
#define RVA_FIND_OF_TYPE oxorany((uintptr_t)0xA096BF8)
#define RVA_GO_GET_TRANS oxorany((uintptr_t)0xA08EA84)
#define RVA_COMP_GET_TRANS oxorany((uintptr_t)0xA089A3C)
#define RVA_GET_POS oxorany((uintptr_t)0xA0A1334)
#define RVA_GET_TYPE oxorany((uintptr_t)0xA6CD5A0)
#define RVA_GET_BONE oxorany((uintptr_t)0x9FE3950)
#define RVA_GET_NAME oxorany((uintptr_t)0xA09597C)
#define RVA_INPUT_MOUSEPOS oxorany((uintptr_t)0xA115E34)
#define RVA_INPUT_MOUSEBTN oxorany((uintptr_t)0xA115E10)
#define RVA_LINECAST oxorany((uintptr_t)0xA13DE98) 
#define RVA_SET_FPS oxorany((uintptr_t)0xA001E94)
#define RVA_SET_NEARCLIP oxorany((uintptr_t)0xA004FFC)
...
#define OFF_ANIMATOR oxorany((uintptr_t)0x188)
